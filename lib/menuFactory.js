...
const mutationData = require('../data/mutationData')
...
module.exports.getMainMenu = (user) => {
    let embed = new MessageEmbed()
        ...
        .setDescription(`SparkBot is a war and roster management tool created by mjdean1994/Technoplex with modifications by plzlearn/jebediahsneed. It's sole purpose is to make roster management easier for war coordinators by presenting character information in an easy-to-consume form and by providing tools to war coordinators to make roster construction easier.\n\n[GitHub Repository](https://github.com/plzlearn/sparkbot-renewed)`)
        .setColor("#DAA520")
    let components = []
    ...
    row.addComponents(new MessageButton().setCustomId('mainMenuManageMutationsBtn').setLabel('Manage Mutations').setStyle('PRIMARY'))
...
module.exports.getCharacterMenu = (character) => {
    ...
    let row1 = new MessageActionRow()
        ...
        .addComponents(new MessageButton().setCustomId('manageCharacterFaction').setLabel('Update Faction').setStyle('PRIMARY'))
    ...
    let row2 = new MessageActionRow()
        .addComponents(new MessageButton().setCustomId('manageCharacterRole').setLabel('Update Role').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageCharacterWeapons').setLabel('Update Weapons').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageCharacterHeartrune').setLabel('Update Heartrune').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageCharacterWeight').setLabel('Update Weight').setStyle('PRIMARY'))
    let row3 = new MessageActionRow()
        .addComponents(new MessageButton().setCustomId('manageCharacterWarInterest').setLabel('Update War').setStyle('PRIMARY'))
...
module.exports.getMutationMenu = (mutation) => {
    let embed = mutation.embed
    let row1 = new MessageActionRow()
        .addComponents(new MessageButton().setCustomId('manageMutationName').setLabel('Update Name').setStyle('PRIMARY'))
    let row2 = new MessageActionRow()
        .addComponents(new MessageButton().setCustomId('manageMutationGenesisCodex').setLabel('Update Genesis Codex').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageMutationGenesisRole').setLabel('Update Genesis Role').setStyle('PRIMARY'))
    let row3 = new MessageActionRow()
        .addComponents(new MessageButton().setCustomId('manageMutationLazarusCodex').setLabel('Update Lazarus Codex').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageMutationLazarusRole').setLabel('Update Lazarus Role').setStyle('PRIMARY'))
    let row4 = new MessageActionRow()
        .addComponents(new MessageButton().setCustomId('manageMutationDynastyCodex').setLabel('Update Dynasty Codex').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageMutationDynastyRole').setLabel('Update Lynasty Role').setStyle('PRIMARY'))
    let row5 = new MessageActionRow()
        .addComponents(new MessageButton().setCustomId('manageMutationTempestCodex').setLabel('Update Tempest Codex').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageMutationTempestRole').setLabel('Update Tempest Role').setStyle('PRIMARY'))
    let row6 = new MessageActionRow()
        .addComponents(new MessageButton().setCustomId('manageMutationDepthsCodex').setLabel('Update Depths Codex').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageMutationDepthsRole').setLabel('Update Depths Role').setStyle('PRIMARY'))
    let row7 = new MessageActionRow()
        .addComponents(new MessageButton().setCustomId('manageMutationBarnaclesCodex').setLabel('Update Barnacles Codex').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageMutationBarnaclesRole').setLabel('Update Barnacles Role').setStyle('PRIMARY'))
    let row8 = new MessageActionRow()
        .addComponents(new MessageButton().setCustomId('manageMutationEnneadCodex').setLabel('Update Ennead Codex').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageMutationEnneadRole').setLabel('Update Ennead Role').setStyle('PRIMARY'))
    let row9 = new MessageActionRow()
        .addComponents(new MessageButton().setCustomId('manageMutationStarstoneCodex').setLabel('Update Starstone Codex').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageMutationStarstoneRole').setLabel('Update Starstone Role').setStyle('PRIMARY'))
    return { embeds: [embed], components: [row1, row2, row3, row4, row5, row6, row7, row8, row9] }
}
