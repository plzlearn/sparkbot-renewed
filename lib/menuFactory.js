...
module.exports.getMainMenu = (user) => {
    let embed = new MessageEmbed()
        ...
        .setDescription(`SparkBot is a war and roster management tool created by mjdean1994/Technoplex. It's sole purpose is to make roster management easier for war coordinators by presenting character information in an easy-to-consume form and by providing tools to war coordinators to make roster construction easier.\n\n[Roster Spreadsheet](https://docs.google.com/spreadsheets/d/${spreadsheetId}/edit?usp=sharing)\n[GitHub Repository](https://github.com/mjdean1994/sparkbot)`)
        .setColor("#DAA520")
    let components = []
